...
const api = {
  ...
  createClass: (createClassForm) => { return axios.post('/api/createbanji/', { 'name': createClassForm.name, 'year': createClassForm.year, 'season': createClassForm.season, 'couid': createClassForm.lessonId }) },
